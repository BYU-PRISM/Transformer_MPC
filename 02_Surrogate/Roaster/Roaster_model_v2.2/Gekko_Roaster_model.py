...
#     Sul_in.value = data_tph["Sulfur_in"][i]
#     m.solve(disp=True)
#     print(T_reactor1.MODEL)
#     T1_store[i] =  T_reactor1.MODEL
...
def process(input):
    S2.value = input.Sulf_in
    CO3.value = input.CO3_in
    TCM.value = input.Carbon_in
    Gold_in.value = input.Gold_in
    Ore_in.value = input.Ore_in
    Sul_in.value = input.Sulfur_in
    O2_in.value = input.O2_in
    ...
    output.SO2 = wp_og1["SO2"]
    output.TCM = wp_calcine2["TCM"]
    output.FeS2 = wp_calcine2["FeS2"]
    output.CaCO3 = wp_calcine2["CaCO3"]
